  ...
  installLanguageTemplate: function () {
    if (this.config.get('clientLanguage') === 'es6') {
      Promise.all([
        ...
        'client/source/reducers/models',
        'client/source/utils/model-effect.js',
        'client/source/utils/model-effect.test.js',
        'client/source/utils/model-reducer.js',
        'client/source/utils/model-reducer.test.js',
        ...
        'client/source/constants/model.json',
